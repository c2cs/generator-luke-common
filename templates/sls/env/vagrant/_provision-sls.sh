...
exec_github_script "yum-install-docker"
exec_github_script "install-aws-cli"

# Project Specific Scripts
source "$PROVISION_SCRIPT_ROOT/project/load-credentials.sh"
source "$PROVISION_SCRIPT_ROOT/project/sls-devutils.sh"
